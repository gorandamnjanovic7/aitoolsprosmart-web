...
const V8StockBerza = () => {
  ...
  const premiumPaketi = paketi.filter(p => { 
      ...
      return !fmt.includes('45MP MASTERWORK BUNDLE') && !fmt.includes('60MP SIGNATURE BUNDLE') && !fmt.includes('150MP ULTRA PRINT BUNDLE') && !fmt.includes('150MP ANCIENT CIVILIZATIONS') && !fmt.includes('150MP ULTRA MYSTIC BUNDLE'); 
  });
    ...
    <div className="min-h-screen bg-[#050505] font-sans text-white relative transition-all duration-1000 ease-in-out">
      ...
      <div className="relative z-10 pt-32 pb-24 px-6">
        ...
        <div className="max-w-[1800px] mx-auto w-full">
          ...
          {/* OVO JE BEZBEDNO (VIDE SAMO ADMINI) */}
          {isAdmin && (
      ...
      {/* 🔥 KOREKTNO POZICIONIRANI MODALI (SADA NE FALI NIJEDAN TAG) 🔥 */}
