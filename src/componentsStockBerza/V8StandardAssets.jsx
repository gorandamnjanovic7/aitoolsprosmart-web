              ...
              <div className="flex items-center justify-between">
                ...
                {isAdmin || jeKupljen ? (
                  <a href={paket.zipLink} target="_blank" rel="noopener noreferrer" className="bg-emerald-600 hover:bg-emerald-500 text-white px-5 py-3 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.5)] transition-all">DOWNLOAD <Download className="w-4 h-4" /></a>
                    ...
                    <button onClick={() => prijavaIKupovina({ ...paket, nazivEn: tacanNaziv })} className="hover:scale-105 text-white px-5 py-3 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center gap-2 transition-all shadow-lg bg-gradient-to-r from-orange-600 to-amber-500 shadow-[0_0_15px_rgba(234,88,12,0.4)]">
