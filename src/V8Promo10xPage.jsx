...
const V8Promo10xPage = () => {
  ...
  // Početak funkcije: useEffect (Firebase fetch)
  useEffect(() => {
  ...
  // Početak funkcije: handlePlayVideo
  ...
  // Kraj funkcije: handlePlayVideo

  // Početak funkcije: handleVideoEnded
  const handleVideoEnded = () => {
    setIsPlaying(false); 
    // Automatski izlazak iz Full Screena kada se video završi
  ...
  // Kraj funkcije: handleVideoEnded

  // Početak funkcije: toggleFullScreen
  // V8 Premium funkcija: Dvoklik za Full Screen
  ...
  // Kraj funkcije: toggleFullScreen
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white pt-24 pb-20 font-sans selection:bg-orange-500 selection:text-white">
      ...
      {/* --- V8 BESKONAČNA TRAKA (Izmenjeno: Dugme iznad trake) --- */}
      <div className="w-full mb-20 overflow-hidden bg-black py-10 border-y border-white/5">
       ...
       {/* --- DUGME IZNAD TRAKE --- */}
        ...
        {/* Traka za klizanje slika (Sada potpuno čista, slike su 100% vidljive) */}
        <div className="v8-slider-container-small flex overflow-hidden">
          <div className="v8-track-fast flex w-max hover:[animation-play-state:paused] transition-all" style={{ animationDuration: '150s' }}>
            ...
            {/* Prvi set slika (Povećane dimenzije: w-[260px] md:w-[360px]) */}
