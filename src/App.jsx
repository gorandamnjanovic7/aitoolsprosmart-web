...
// KRAJ: Logika za praćenje skrola
  ...
  return (
    ...
    <Route path="/media" element={<V8PageWrapper><V8MediaViewer /></V8PageWrapper>} />
      ...
      {/* JEDAN JEDINI FOOTER */}
      <footer className="flex flex-col items-center gap-6 text-center text-zinc-100 font-black italic uppercase text-[9px] tracking-[0.5em] py-8 mt-8 border-t border-orange-500/50">
        ...
        <div className="w-full px-6 flex flex-col items-center gap-3">
           ...
           <div className="text-zinc-500/60 font-medium text-[9px] mt-2 max-w-4xl text-center leading-relaxed px-4">
