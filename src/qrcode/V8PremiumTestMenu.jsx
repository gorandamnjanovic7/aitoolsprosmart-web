      ...
      <main className="max-w-[1600px] mx-auto px-4 md:px-12 py-10 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 relative z-10 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col gap-8 w-full max-w-full">
            ...
            <div className="bg-[#1c1c22] border border-white/5 rounded-[2rem] p-6 md:p-8 flex flex-col shadow-[0_15px_35px_rgba(0,0,0,0.5)] w-full h-[880px]">
              ...
              <div className="flex flex-col gap-10 overflow-y-auto overflow-x-visible mt-8 flex-1 pl-2 pr-4 pb-4 v8-beautiful-scroll">
                {CATEGORY_LIMITS.map((cat, catIndex) => {
                  ...
                  return (
                    <div key={`demo-${cat.name}`} className="shrink-0 bg-[#24242a] border border-white/5 rounded-3xl p-6 md:p-8 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
            ...
            <div className={`p-8 md:p-10 border rounded-[2rem] flex flex-col items-center justify-between gap-8 transition-all bg-[#101014] shadow-[0_15px_35px_rgba(0,0,0,0.6)] ${currentTheme.border}`}>
              {!generatedMenuId ? (
              ...
              <div className="bg-[#1c1c22] border border-white/5 rounded-[2rem] p-6 md:p-8 flex flex-col shadow-[0_15px_35px_rgba(0,0,0,0.5)] w-full h-[880px]">
                ...
                <div className="flex flex-col gap-10 overflow-y-auto overflow-x-visible mt-8 flex-1 pl-2 pr-4 pb-4 v8-beautiful-scroll">
                  {CATEGORY_LIMITS.map((cat, catIndex) => {
                    ...
                    return (
                      <div key={`custom-${cat.name}`} className="shrink-0 bg-[#24242a] border border-white/5 rounded-3xl p-6 md:p-8 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
                        <div className="flex items-center justify-between bg-[#16161a] p-5 rounded-2xl border border-white/5 mb-8">
                ...
                <div className={`mt-6 p-8 md:p-10 border rounded-[2rem] flex flex-col items-center justify-between gap-8 transition-all bg-[#101014] shadow-[0_15px_35px_rgba(0,0,0,0.6)] shrink-0 ${currentCustomTheme.border}`}>
            ...
            */}
            <div className="flex flex-col gap-12 sticky top-[100px] w-full max-h-[calc(100vh-120px)] overflow-y-auto overflow-x-visible pl-4 pr-12 py-10 v8-beautiful-scroll">
              ...
              {STATIC_CARDS.map((card) => {
                ...
                return (
                  <div key={card.key} className={`w-full max-w-[280px] mx-auto bg-[#1c1c22] border rounded-[2rem] p-6 flex flex-col items-center text-center shadow-[0_0_40px_rgba(0,0,0,0.6)] transition-all ${card.theme.border}`}>
                    {!generatedId ? (
