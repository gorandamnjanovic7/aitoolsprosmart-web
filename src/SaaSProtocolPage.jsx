...
export default function SaaSProtocolPage({ openCheckout }) {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-300 font-sans selection:bg-amber-500 selection:text-black">
      ...
      {/* 🔥 OMNI KONTROLNI V8 PANEL 🔥 */}
      {isAdminMode && (
        <div className="fixed top-24 right-6 bg-[#0a0a0a]/95 backdrop-blur-xl border-2 border-amber-500 p-6 rounded-2xl z-[999999] text-xs text-amber-500 shadow-[0_0_40px_rgba(245,158,11,0.4)] w-80 font-mono max-h-[80vh] overflow-y-auto custom-scrollbar">
          <h3 className="font-black text-white text-sm mb-4 uppercase border-b border-amber-500/20 pb-2 flex items-center gap-2">
      ...
      <section className="py-12 px-6 bg-[#0a0a0a] border-t border-white/5">
