...
export default function V8GridSystem() {
  ...
  if (UNDER_CONSTRUCTION) {
    return (
      <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 pt-20 font-sans">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-4xl mx-auto bg-gradient-to-b from-[#0a192f]/80 to-[#020617]/90 border border-blue-500/30 p-10 md:p-16 rounded-[3rem] shadow-[0_0_50px_rgba(59,130,246,0.15)] relative overflow-hidden backdrop-blur-xl text-center">
           ...
           <div className="relative z-10 flex flex-col items-center">
               ...
               <h2 className="text-3xl md:text-4xl font-black text-white uppercase tracking-[0.2em] mb-4 drop-shadow-md">
                  SYSTEM <span className="text-blue-500">CALIBRATION</span>
               </h2>
               ...
               <div className="inline-block bg-blue-900/30 border border-blue-500/30 px-4 py-1.5 rounded-full text-blue-300 font-bold uppercase tracking-widest text-[10px] mb-8">
                  V8 GRID SYSTEM PROTOCOL
               </div>
               
               <p className="text-zinc-300 text-[14px] md:text-[16px] leading-relaxed max-w-2xl font-medium mb-6">
                  We are currently deploying the final architectural upgrades to the <strong className="text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">V8 Grid System</strong>. 
               </p>
               <p className="text-zinc-400 text-[13px] md:text-[15px] leading-relaxed max-w-2xl mb-10">
                  This engine is exclusively engineered for mass prompt generation in the premium 2x4 Grid format. Due to our uncompromising standards for Nano Banana 2 optimization, this module is temporarily locked for calibration and will be available imminently.
               </p>
               
               <div className="mx-auto bg-black/60 p-6 rounded-2xl border border-blue-500/30 w-fit shadow-inner mb-8">
                  <p className="text-[10px] font-black uppercase tracking-widest text-blue-400 mb-4 text-center">Target Layout: 2x4 Cinematic Grid</p>
                  <div className="grid grid-cols-4 grid-rows-2 gap-2">
                      {[...Array(8)].map((_, i) => (
                          <div key={i} className="w-14 h-10 bg-blue-500/20 border border-blue-500/40 rounded-md flex items-center justify-center shadow-[0_0_10px_rgba(59,130,246,0.2)]">
                              <span className="text-[10px] font-black text-blue-300 opacity-60">P{i+1}</span>
                          </div>
                      ))}
                  </div>
              </div>

               <div className="mt-4 flex items-center justify-center gap-3 text-blue-400 font-black uppercase tracking-widest text-[12px] bg-black/40 px-6 py-4 rounded-xl border border-blue-500/20 shadow-inner">
                  <RefreshCw className="w-4 h-4 animate-spin" /> ESTIMATING COMPLETION TIME...
               </div>
           </div>
        </motion.div>
      </div>
      ...
      return (
        <div className="min-h-[75vh] flex items-center justify-center px-6 font-sans">
            <div className="max-w-md w-full bg-[#0a0a0a] border border-orange-500/40 rounded-3xl p-10 text-center shadow-[0_0_50px_rgba(234,88,12,0.15)] relative overflow-hidden">
                ...
                <h2 className="text-2xl font-black uppercase text-white tracking-widest mb-2">V8 GRID SYSTEM</h2>
