// POČETAK FAJLA: V8PremiumMenu.jsx
...
export default function V8PremiumMenu() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

  // 🔥 GIGANTSKI DEMO MENI UNAPRED UČITAN ZA BRZO TESTIRANJE 🔥
  const [restaurantName, setRestaurantName] = useState('AURA Fine Dining & Lounge');
  const [currency, setCurrency] = useState('€');
  const [themeColor, setThemeColor] = useState('#eab308'); // Zlatna boja za luksuz

  const [items, setItems] = useState([
    { id: 1, category: "House Special", name: "Wagyu A5 Tomahawk", desc: "Pure Japanese Wagyu beef, 24k gold leaf flakes, black truffle mash.", price: "140.00" },
    { id: 2, category: "House Special", name: "Beluga Caviar & Blinis", desc: "30g premium Beluga caviar served with traditional blinis and crème fraîche.", price: "210.00" },
    { id: 3, category: "Soups", name: "Lobster Bisque", desc: "Creamy Maine lobster soup infused with cognac and fresh tarragon.", price: "28.00" },
    { id: 4, category: "Soups", name: "French Onion Soup", desc: "Caramelized onions, rich beef broth, topped with melted Gruyère cheese.", price: "18.00" },
    { id: 5, category: "Salads", name: "Burrata & Heirloom Tomato", desc: "Fresh Italian burrata, organic heirloom tomatoes, basil pesto, balsamic glaze.", price: "22.00" },
    { id: 6, category: "Salads", name: "Caesar Royal", desc: "Crisp romaine, quail eggs, pancetta crisps, parmesan shavings, truffle dressing.", price: "24.00" },
    { id: 7, category: "Starters", name: "Royal Beef Tartare", desc: "Hand-cut premium beef tenderloin, quail egg, capers, white truffle oil.", price: "45.00" },
    { id: 8, category: "Starters", name: "Hokkaido Scallops", desc: "Pan-seared sea scallops with saffron puree and crispy pancetta dust.", price: "38.00" },
    { id: 9, category: "Pizza", name: "Truffle Mushroom Pizza", desc: "White base, fior di latte, wild forest mushrooms, fresh black truffle shavings.", price: "32.00" },
    { id: 10, category: "Pizza", name: "Diavola Premium", desc: "San Marzano tomato sauce, spicy Calabrian salami, fresh basil, mozzarella.", price: "25.00" },
    { id: 11, category: "Pasta", name: "Lobster Linguine", desc: "Fresh handmade linguine, cherry tomatoes, chili, half-tail of Atlantic lobster.", price: "48.00" },
    { id: 12, category: "Pasta", name: "Truffle Gnocchi", desc: "Potato gnocchi, rich parmesan cream sauce, topped with fresh black truffles.", price: "36.00" },
    { id: 13, category: "Mains", name: "Chilean Sea Bass", desc: "Miso-glazed sea bass filet served on a bed of squid ink risotto.", price: "95.00" },
    { id: 14, category: "Mains", name: "Duck Breast à l'Orange", desc: "Pan-seared duck breast, sweet potato purée, Grand Marnier orange reduction.", price: "65.00" },
    { id: 15, category: "Desserts", name: "24k Gold Chocolate Sphere", desc: "Dark Belgian chocolate filled with hazelnut mousse, melted tableside.", price: "35.00" },
    { id: 16, category: "Desserts", name: "Tiramisu Authentico", desc: "Mascarpone cream, espresso-soaked ladyfingers, premium cocoa dusting.", price: "18.00" },
    { id: 17, category: "Drinks", name: "Dom Pérignon Vintage 2013", desc: "Luminous and elegant champagne with notes of citrus and toasted brioche.", price: "450.00" },
    { id: 18, category: "Drinks", name: "Signature Roku Cocktail", desc: "Roku Gin, yuzu extract, smoked rosemary, and a touch of gold dust.", price: "25.00" },
    { id: 19, category: "Drinks", name: "Acqua Panna (750ml)", desc: "Natural still mineral water from Tuscany.", price: "8.00" }
  ]);
  ...
  const handleAddItem = () => {
    setItems([...items, { id: Date.now(), category: 'Mains', name: '', desc: '', price: '' }]);
  };
